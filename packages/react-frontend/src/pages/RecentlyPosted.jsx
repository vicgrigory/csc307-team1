...
export default function RecentlyPosted() {
  const recentlyPosted = [
    { id: 10, title: "Probability for CS", type: "Book", author: "Bret Holladay", image: "https://via.placeholder.com/200x280?text=Probability", views: 720, uploadedAt: "2025-01-19T14:45:00Z", description: "Recently added textbook on probability." },
    ...
    { id: 6, title: "Machine Learning Basics", type: "Other", author: "Paul Anderson", image: "https://via.placeholder.com/200x280?text=ML+Basics", views: 845, uploadedAt: "2025-01-15T13:00:00Z", description: "Introductory material for machine learning." },
    { id: 5, title: "Data Structures in C++", type: "Book", author: "Christopher Siu", image: "https://via.placeholder.com/200x280?text=C++", views: 860, uploadedAt: "2025-01-14T09:20:00Z", description: "C++ data structures explained with examples." },
    { id: 4, title: "Discrete Mathematics Essentials", type: "Book", author: "Christopher Siu", image: "https://via.placeholder.com/200x280?text=Discrete+Math", views: 975, uploadedAt: "2025-01-12T11:15:00Z", description: "Core concepts in discrete mathematics." },
    ...
    { id: 1, title: "Introduction to Algorithms", type: "Book", author: "Christopher Siu", image: "https://via.placeholder.com/200x280?text=Algorithms", views: 1542, uploadedAt: "2025-01-05T10:00:00Z", description: "Classic textbook introducing algorithms." },
  ];
